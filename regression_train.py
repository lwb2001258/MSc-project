...
def plot_parity(y_true, y_pred, y_pred_unc=None):
    ...
    return
f = open("test_args/regression_{}.csv".format(str(time.time())),'w')
...
def objective(params):
    ...
    arguments = [
        '--data_path', 'data/enhance_regression3.csv',
        '--dataset_type', 'regression',
        '--save_dir', 'test_models/regression/test_checkpoints_reg_{}'.format(time_str),
        '--epochs', str(epochs),
        '--save_smiles_splits',
...
#     "dropout": hp.choice("dropout",[ 0.3,0.35,0.4]),
#     "init_lr": hp.choice("init_lr",[0.00001,0.000001 ]),
#     "final_lr": hp.choice("final_lr",[0.00001,0.000001]),
#     "num_folds": hp.choice("num_folds", [1]),
#     "ensemble_size": hp.choice("ensemble_size",[5,10]),
#     "max_lr": hp.choice("max_lr",[0.0001]),
# }
