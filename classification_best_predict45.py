...
dir_path = 'predict/classification/best/45'
file_list = []
file_name_list = []
...
check_dirs = []
rootdir = 'test_models/classification/best/45'
    ...
    if file_name not in file_name_list:
        try:
            arguments = [
                ...
                '--preds_path', 'predict/classification/best/45/{}.csv'.format(file_name),
                '--checkpoint_dir', dir,
                '--num_workers', '0'
            ]
            ...
            with open('predict/classification/best/45/{}.csv'.format(file_name)) as f:
                content = f.readlines()
            result_info = {}
            for index, line in enumerate(content):
                if index != 0:
