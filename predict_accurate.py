...
check_dirs = []
rootdir = 'predict/classification'
...
for dir in check_dirs:
    try:
        ...
        with open("predict/classification/{}".format(file_name))as f:
            content = f.readlines()
        ...
        try:
            ...
            json_file = open('test_models/classification/{}/args.json'.format(dir_name), 'r')
            ...
            csv_file ="predict/classification/{}".format(file_name)
